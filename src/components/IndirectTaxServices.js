    ...
    <div className="flex flex-col lg:flex-row">
      <div className="w-full lg:w-64 bg-gray-100 p-5 lg:p-6">
        ...
        <ul className="text-sm">
          ...
          <li className="mb-2">
            <a href="/indirect-tax-services" className="block p-2 bg-yellow-300">Indirect Tax</a>
          </li>
          <li className="mb-2">
            <a href="/corporate-and-LLP-Laws" className="block p-2 hover:bg-yellow-200">Auditing and Assurance Services</a>
          </li>
          <li className="mb-2">
