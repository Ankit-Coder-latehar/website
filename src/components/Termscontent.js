  ...
  return (
    <div className="flex">
      <div className="w-64 h-280 p-5 bg-gray-100 p-20">
        <h2 className="font-semibold text-lg mb-5">Terms</h2>
...
By accessing the site, and any pages thereof, you agree to be bound by the terms and conditions below. The information<br/> and material contained in these pages and the terms, conditions and descriptions that appear are subject to change.”<br/>
<br/>
