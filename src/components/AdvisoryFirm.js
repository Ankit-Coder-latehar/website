...
const AdvisoryFirmSection = () => {
  return (
    <div className="flex flex-col md:flex-row w-full min-h-screen">
      ...
      <div className="md:w-1/2 w-full h-64 md:h-full flex items-center justify-center px-0 md:px-20 py-10">
        <img
          src="/CA-India-Logo.png" 
          alt="Advisory Firm Office"
          className="object-contain h-48 w-48 sm:h-64 sm:w-64 md:h-full md:w-full"
        />
      </div>
